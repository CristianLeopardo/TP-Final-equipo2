    ...
    <div class="d-flex justify-content-center align-items-center vh-80" style="margin: 20px">
        ...
        <div class="bg-white p-3 rounded-5 text-secondary shadow w-100">
            ...
            <div class="text-center">
                <asp:ValidationSummary runat="server" DisplayMode="BulletList" CssClass="text-danger fs-2" HeaderText="<i class='bi bi-exclamation-triangle-fill'></i> Complete los campos obligatorios <i class='bi bi-exclamation-triangle-fill'></i>" ValidationGroup="GrupoRegistro" />
            </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-4 text-center">
                    ...
                    <asp:Label ID="lblNOK" Visible="false" CssClass="form-label alert-link accordion-button" ForeColor="Red" runat="server" Text="La contraseña o el email no coinciden"></asp:Label>
                </div>
            </div>
